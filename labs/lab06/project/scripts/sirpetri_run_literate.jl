# # Lab 6. Baseline SIR run with Petri nets
# This script performs one baseline experiment for the SIR model.
# It saves deterministic and stochastic trajectories and writes plots.
#
# ## Project setup
