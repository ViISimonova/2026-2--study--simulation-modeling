```@meta
EditURL = "../scripts/sir_optimize_parameters_literate.jl"
```

# Multi-objective Optimization of SIR Parameters

This literate script uses a Pareto-based evolutionary search to reduce
both the epidemic peak and the fraction of deaths.

````@example sir_optimize_parameters_literate
using DrWatson
