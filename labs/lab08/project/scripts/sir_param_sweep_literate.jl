# # Parameter sweep for the discrete-event SIR model
#
# This script runs the SIR model with several values of infection probability,
# contact rate, and recovery rate. It saves comparison plots and a metrics table.
