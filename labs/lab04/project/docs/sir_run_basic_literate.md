```@meta
EditURL = "../scripts/sir_run_basic_literate.jl"
```

# Basic SIR Experiment

This literate script runs the baseline agent-based SIR model and stores
the dynamics of susceptible, infected, recovered, and total population.

````@example sir_run_basic_literate
using DrWatson
