```@meta
EditURL = "../scripts/sir_scan_beta_literate.jl"
```

# Beta Scan for the Agent-Based SIR Model

This literate script scans the infection parameter `beta` and stores
aggregated epidemic indicators for several random seeds.

````@example sir_scan_beta_literate
using DrWatson
